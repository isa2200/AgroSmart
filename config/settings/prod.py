...
if not ALLOWED_HOSTS or ALLOWED_HOSTS == [""]:
    ALLOWED_HOSTS = ["localhost", "127.0.0.1", "172.30.0.58", "172.18.0.3"]
...
if "http://172.30.0.58:8000" not in CSRF_TRUSTED_ORIGINS:
    CSRF_TRUSTED_ORIGINS.append("http://172.30.0.58:8000")
...
if DEBUG:
    ...
    try:
        ...
        INTERNAL_IPS = ['127.0.0.1', '172.18.0.1', '172.30.0.58'] + local_ips
    except ImportError:
        pass
