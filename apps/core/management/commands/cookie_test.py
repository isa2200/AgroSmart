...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        hosts = ['localhost:8000', '127.0.0.1:8000', '172.30.0.58:8000']
        ...
        print("3. Luego accede a http://172.30.0.58:8000")
        ...
        print("5. Intenta limpiar cookies del navegador para 172.30.0.58")